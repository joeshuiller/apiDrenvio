...
class SocialStratumRepositoryImpl {
    constructor() {
        this.include = null;
        this.condition = null;
    }
    socialStratumPagination(item) {
        this.response = null;
        this.condition = null;
        this.condition = utilityMethods_1.default.whereCondition(item);
        this.response = utilityMethods_1.default.pagination(SocialStratum_1.default, item, this.include, this.condition);
    ...
    registerAll(clientsId) {
        return new Promise((resolve, reject) => {
            SocialStratum_1.default.findAll({
                where: {
    ...
    save(register) {
        return new Promise((resolve, reject) => {
            config_1.sequelize.transaction().then(t => {
                SocialStratum_1.default.create(register, { transaction: t }).then(res => {
    ...
    retrieveById(registerId, saveID) {
        return new Promise((resolve, reject) => {
            SocialStratum_1.default.findOne({
                where: {
                    id: saveID,
                    name: registerId
                }
    ...
    update(socialStratums) {
        throw new Error("Method not implemented.");
    }
    delete(socialStratumsId) {
        throw new Error("Method not implemented.");
    }
    deleteAll() {
        throw new Error("Method not implemented.");
...
exports.default = new SocialStratumRepositoryImpl();
//# sourceMappingURL=SocialStratumRepositoryImpl.js.map