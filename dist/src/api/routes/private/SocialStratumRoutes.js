...
const SocialStratumController_1 = __importDefault(require("../../controllers/SocialStratumController"));
class SocialStratumRoutes {
    constructor() {
        this.router = (0, express_1.Router)();
        this.controller = new SocialStratumController_1.default;
    ...
    intializeRoutes() {
        ...
        this.router.get("/", this.controller.socialStratumPagination);
...
exports.default = new SocialStratumRoutes().router;
//# sourceMappingURL=SocialStratumRoutes.js.map