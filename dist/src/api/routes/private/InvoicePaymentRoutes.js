...
const InvoicePaymentController_1 = __importDefault(require("../../controllers/InvoicePaymentController"));
const auth_1 = require("../auth");
class InvoicePaymentRoutes {
    constructor() {
        this.router = (0, express_1.Router)();
        this.controller = new InvoicePaymentController_1.default;
...
exports.default = new InvoicePaymentRoutes().router;
//# sourceMappingURL=InvoicePaymentRoutes.js.map