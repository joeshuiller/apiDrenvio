...
class AssignTechnicianRoutes {
    ...
    intializeRoutes() {
        ...
        this.router.get("/:id", auth_1.auth, this.controller.getMenusAll);
...
exports.default = new AssignTechnicianRoutes().router;
//# sourceMappingURL=AssignTechnicianRoutes.js.map