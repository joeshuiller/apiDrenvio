...
class PropertyRoutes {
    constructor() {
        ...
        this.controller = new PropertyController_1.default;
    ...
    intializeRoutes() {
        ...
        this.router.get("/", auth_1.auth, this.controller.propertyPagination);
...
exports.default = new PropertyRoutes().router;
