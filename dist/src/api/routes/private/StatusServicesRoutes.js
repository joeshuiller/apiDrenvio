...
const StatusServicesController_1 = __importDefault(require("../../controllers/StatusServicesController"));
const auth_1 = require("../auth");
class StatusServicesRoutes {
    constructor() {
        this.router = (0, express_1.Router)();
        this.controller = new StatusServicesController_1.default;
...
exports.default = new StatusServicesRoutes().router;
//# sourceMappingURL=StatusServicesRoutes.js.map