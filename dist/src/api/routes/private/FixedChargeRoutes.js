...
const FixedChargeController_1 = __importDefault(require("../../controllers/FixedChargeController"));
const auth_1 = require("../auth");
class FixedChargeRoutes {
    constructor() {
        this.router = (0, express_1.Router)();
        this.controller = new FixedChargeController_1.default;
...
exports.default = new FixedChargeRoutes().router;
//# sourceMappingURL=FixedChargeRoutes.js.map