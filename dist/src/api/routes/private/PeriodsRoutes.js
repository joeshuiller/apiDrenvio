...
class PeriodsRoutes {
    constructor() {
        ...
        this.controller = new PeriodsController_1.default;
    ...
    intializeRoutes() {
        ...
        this.router.get("/", auth_1.auth, this.controller.periodsPagination);
...
exports.default = new PeriodsRoutes().router;
//# sourceMappingURL=PeriodsRoutes.js.map