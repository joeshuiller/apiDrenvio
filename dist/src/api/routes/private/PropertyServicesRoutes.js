...
const PropertyServicesController_1 = __importDefault(require("../../controllers/PropertyServicesController"));
const auth_1 = require("../auth");
class PropertyServicesRoutes {
    constructor() {
        this.router = (0, express_1.Router)();
        this.controller = new PropertyServicesController_1.default;
...
exports.default = new PropertyServicesRoutes().router;
//# sourceMappingURL=PropertyServicesRoutes.js.map