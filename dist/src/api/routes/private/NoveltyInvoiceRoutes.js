...
const NoveltyInvoiceController_1 = __importDefault(require("../../controllers/NoveltyInvoiceController"));
const auth_1 = require("../auth");
class NoveltyInvoiceRoutes {
    constructor() {
        this.router = (0, express_1.Router)();
        this.controller = new NoveltyInvoiceController_1.default;
...
exports.default = new NoveltyInvoiceRoutes().router;
//# sourceMappingURL=NoveltyInvoiceRoutes.js.map